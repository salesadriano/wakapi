---
name: prd-generator
description: Generate comprehensive Product Requirements Documents for product, business, or delivery roles. Use this skill when users ask to create a PRD, formalize product requirements, document a feature, or structure a scoped requirement set. In this package, it supports the Business Analyst and does not replace System Design or mandatory closure templates.
---
