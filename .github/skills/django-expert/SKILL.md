---
name: django-expert
description: Primary Django implementation skill for models, views, serializers, DRF endpoints, migrations, and ORM debugging inside an existing Django codebase. Prefer django-patterns for higher-level project structure decisions, django-security for hardening, and django-tdd for test strategy.
---
