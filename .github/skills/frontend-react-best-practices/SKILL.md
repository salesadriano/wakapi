...
- [Hooks Patterns Quick Reference](references/hooks-patterns.md) — data fetching, stale closures, derived state, context splitting, useReducer, performance checklist
