...
# SECURITY WARNING: MD5PasswordHasher is intentionally insecure and exists only to
# speed up test suites. MD5 is a broken hash algorithm for passwords — it is trivially
# crackable with rainbow tables. NEVER add this to development, staging, or production
# settings. Production must use Django's default PBKDF2PasswordHasher or Argon2.
PASSWORD_HASHERS = [
    'django.contrib.auth.hashers.MD5PasswordHasher',  # test-only
]
