---
name: fastapi-expert
description: "Primary implementation skill for building production FastAPI services with Pydantic V2. Invoke when creating or refactoring endpoints, schemas, authentication flows, async SQLAlchemy access, WebSocket endpoints, or OpenAPI-documented APIs. Prefer fastapi-templates for initial scaffolding and fastapi-async-patterns for deep concurrency/performance reviews. Trigger terms: FastAPI, Pydantic, async Python, Python API, REST API Python, SQLAlchemy async, JWT authentication, OpenAPI, Swagger Python."
license: MIT
metadata:
